...
export const LOG_TYPES = [
  ...
  { value: 51, label: 'Param Intercept', color: 'amber' },
] as const
 ...
 */
export const DISPLAYABLE_LOG_TYPES = [0, 2, 5, 6, 51] as const

/**
 * Log types that show timing info
 */
export const TIMING_LOG_TYPES = [2, 5, 51] as const
