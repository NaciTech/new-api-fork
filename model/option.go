...
func InitOptionMap() {
	...
	common.OptionMap["operation_setting.param_preflight_interception_rules"] = operation_setting.ParamPreflightInterceptionRulesToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "operation_setting.param_preflight_interception_rules":
		err = operation_setting.UpdateParamPreflightInterceptionRules(value)
